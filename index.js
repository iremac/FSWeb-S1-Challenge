...
console.log(fenomenler[6].profile.isim);
...
console.log(
  "görev 6 yeni elemanlı dizi",
  fenomenEkle(fenomenler, 140, "ebru", 400000, 2023, "ebrebr")
);
...
function platformaGoreCokGonderiYapanFenomen(fenomenler, platformAdi) {
  ...
  fenomenler.forEach((fenomen) => {
    if (
      fenomen.platform === platformAdi &&
      fenomen.posts !== "NA" &&
      fenomen.posts > gonderi
    ) {
